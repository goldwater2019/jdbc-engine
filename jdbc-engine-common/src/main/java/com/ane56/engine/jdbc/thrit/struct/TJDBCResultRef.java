...
public class TJDBCResultRef implements org.apache.thrift.TBase<TJDBCResultRef, TJDBCResultRef._Fields>, java.io.Serializable, Cloneable, Comparable<TJDBCResultRef> {
  ...
  public @org.apache.thrift.annotation.Nullable TJDBCResultSet resultSet; // required
  public @org.apache.thrift.annotation.Nullable TJDBCOperationRef operationRef; // required
