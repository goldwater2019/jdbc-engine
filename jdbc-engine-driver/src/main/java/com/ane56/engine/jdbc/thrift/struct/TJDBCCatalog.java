 ...
 *  @generated
 */
package com.ane56.engine.jdbc.thrift.struct;
...
public class TJDBCCatalog implements org.apache.thrift.TBase<TJDBCCatalog, TJDBCCatalog._Fields>, java.io.Serializable, Cloneable, Comparable<TJDBCCatalog> {
  ...
  public @org.apache.thrift.annotation.Nullable String driver; // required
  ...
  public TJDBCCatalog setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TJDBCCatalog setDriver(@org.apache.thrift.annotation.Nullable String driver) {
    this.driver = driver;
    return this;
  }
  ...
  public TJDBCCatalog setUrl(@org.apache.thrift.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public TJDBCCatalog setUsername(@org.apache.thrift.annotation.Nullable String username) {
    this.username = username;
    return this;
  }
  ...
  public TJDBCCatalog setPassword(@org.apache.thrift.annotation.Nullable String password) {
    this.password = password;
    return this;
  }
  ...
  public int compareTo(TJDBCCatalog other) {
    ...
    lastComparison = Boolean.compare(isSetDriver(), other.isSetDriver());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDriver()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TJDBCCatalog(");
    boolean first = true;
