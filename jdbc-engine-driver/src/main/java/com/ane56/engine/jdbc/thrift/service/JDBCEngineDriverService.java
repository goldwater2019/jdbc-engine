 ...
 *  @generated
 */
package com.ane56.engine.jdbc.thrift.service;
...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.16.0)", date = "2022-03-28")
public class JDBCEngineDriverService {
  ...
  public interface Iface {
     ...
     */
    public boolean heartBeat(TJDBCEngineExecutor jdbcEngineExecutor) throws org.apache.thrift.TException;

    /**
     * 获得相应的心跳
     * 
     */
    public java.util.List<TJDBCCatalog> getCatalogs() throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void heartBeat(TJDBCEngineExecutor jdbcEngineExecutor, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException;

    public void getCatalogs(org.apache.thrift.async.AsyncMethodCallback<java.util.List<TJDBCCatalog>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_heartBeat(TJDBCEngineExecutor jdbcEngineExecutor) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<TJDBCCatalog> recv_getCatalogs() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class heartBeat_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      private TJDBCEngineExecutor jdbcEngineExecutor;
      public heartBeat_call(TJDBCEngineExecutor jdbcEngineExecutor, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class getCatalogs_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<TJDBCCatalog>> {
      public getCatalogs_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<TJDBCCatalog>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
      ...
      public java.util.List<TJDBCCatalog> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class heartBeat<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, heartBeat_args, Boolean> {
      ...
      public void start(I iface, heartBeat_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException {
        iface.heartBeat(args.jdbcEngineExecutor,resultHandler);
      }
    }

    public static class getCatalogs<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getCatalogs_args, java.util.List<TJDBCCatalog>> {
      public getCatalogs() {
        super("getCatalogs");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<TJDBCCatalog>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<TJDBCCatalog>>() { 
          public void onComplete(java.util.List<TJDBCCatalog> o) {
            getCatalogs_result result = new getCatalogs_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getCatalogs_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<TJDBCCatalog>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class heartBeat_args implements org.apache.thrift.TBase<heartBeat_args, heartBeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<heartBeat_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable TJDBCEngineExecutor jdbcEngineExecutor; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.JDBC_ENGINE_EXECUTOR, new org.apache.thrift.meta_data.FieldMetaData("jdbcEngineExecutor", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TJDBCEngineExecutor.class)));
    ...
    public heartBeat_args(
      TJDBCEngineExecutor jdbcEngineExecutor)
    {
      this();
      this.jdbcEngineExecutor = jdbcEngineExecutor;
    }
    ...
    public heartBeat_args(heartBeat_args other) {
      if (other.isSetJdbcEngineExecutor()) {
        this.jdbcEngineExecutor = new TJDBCEngineExecutor(other.jdbcEngineExecutor);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public TJDBCEngineExecutor getJdbcEngineExecutor() {
      return this.jdbcEngineExecutor;
    }

    public heartBeat_args setJdbcEngineExecutor(@org.apache.thrift.annotation.Nullable TJDBCEngineExecutor jdbcEngineExecutor) {
      this.jdbcEngineExecutor = jdbcEngineExecutor;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case JDBC_ENGINE_EXECUTOR:
        if (value == null) {
          ...
          setJdbcEngineExecutor((TJDBCEngineExecutor)value);
        }
        break;
    ...
    public int compareTo(heartBeat_args other) {
      ...
      lastComparison = Boolean.compare(isSetJdbcEngineExecutor(), other.isSetJdbcEngineExecutor());
      if (lastComparison != 0) {
          ...
          switch (schemeField.id) {
            case 1: // JDBC_ENGINE_EXECUTOR
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.jdbcEngineExecutor = new TJDBCEngineExecutor();
...
;
  ...
  public static class getCatalogs_result implements org.apache.thrift.TBase<getCatalogs_result, getCatalogs_result._Fields>, java.io.Serializable, Cloneable, Comparable<getCatalogs_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<TJDBCCatalog> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TJDBCCatalog.class))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getCatalogs_result(
      java.util.List<TJDBCCatalog> success)
    {
      this();
      this.success = success;
    }
    ...
    public getCatalogs_result(getCatalogs_result other) {
      if (other.isSetSuccess()) {
        java.util.List<TJDBCCatalog> __this__success = new java.util.ArrayList<TJDBCCatalog>(other.success.size());
        for (TJDBCCatalog other_element : other.success) {
          __this__success.add(new TJDBCCatalog(other_element));
        }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<TJDBCCatalog> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(TJDBCCatalog elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<TJDBCCatalog>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<TJDBCCatalog> getSuccess() {
      return this.success;
    }

    public getCatalogs_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<TJDBCCatalog> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<TJDBCCatalog>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<TJDBCCatalog>(_list0.size);
                  @org.apache.thrift.annotation.Nullable TJDBCCatalog _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new TJDBCCatalog();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCatalogs_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TJDBCCatalog _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (TJDBCCatalog _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<TJDBCCatalog>(_list5.size);
            @org.apache.thrift.annotation.Nullable TJDBCCatalog _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new TJDBCCatalog();
              _elem6.read(iprot);
